          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/admission_status_entry">{props.t("Admission Status Entry")}</Link>
                </li>
                <li>
                  <Link to="/admitted_through">{props.t("Admitted Through")}</Link>
                </li>
                <li>
                  <Link to="/caste_entry">{props.t("Caste Entry")}</Link>
                </li>
                <li>
                  <Link to="/country">{props.t("Country")}</Link>
                </li>
                <li>
                  <Link to="/course_scheme_entry">{props.t("Course Scheme Entry")}</Link>
                </li>
                {/* <li>
                  <Link to="/courses">{props.t("Courses")}</Link>
                </li> */}
                <li>
                  <Link to="/currency_master">{props.t("Currency Master")}</Link>
                </li>
               <li>
                  <Link to="/document_type_entry">{props.t("Document Type Entry")}</Link>
                </li>
                   <li>
                  <Link to="/document_exam_entry">{props.t("Document Exam Entry")}</Link>
                </li> 
                <li>
                  <Link to="/mother_tongue">{props.t("Mother Tongue")}</Link>
                </li>
                <li>
                  <Link to="/nationality">{props.t("Nationality")}</Link>
                </li>
                <li>
                  <Link to="/cost_category">{props.t("Cost Category")}</Link>
                </li>
             
                <li>
                  <Link to="/applicant_feedback">{props.t("Applicant Feedback")}</Link>
                </li>
                <li>
                  <Link to="/designation">{props.t("Designation")}</Link>
                </li>
                <li>
                  <Link to="/subject_code_group">{props.t("Subject Code Group")}</Link>
                </li>
                   <li>
                  <Link to="/admissionNo_entry">{props.t("AdmissionNo Entry")}</Link>
                </li>
                  <li>
                  <Link to="/resident_category">{props.t("Resident Category")}</Link>
                </li>
                <li>
                  <Link to="/sub_religion">{props.t("Sub Religion")}</Link>
                </li>
                <li>
                  <Link to="/cost_center">{props.t("Cost Center")}</Link>
                </li>
                <li>
                  <Link to="/religion">{props.t("Religion")}</Link>
                </li>
                <li>
                  <Link to="/region">{props.t("Region")}</Link>
                </li>
                <li>
                  <Link to="/pre_requisite_exam">{props.t("Pre-Requisite Exam")}</Link>
                </li>
                <li>
                  <Link to="/occupation">{props.t("Occupation")}</Link>
                </li>
                <li>
                  <Link to="/program_type">{props.t("Program Type")}</Link>
                </li>
                <li>
                  <Link to="/state">{props.t("State")}</Link>
                </li>
                <li>
                  <Link to="/academic_year">{props.t("Academic Year")}</Link>
                </li>
                <li>
                  <Link to="/certificate_request_purpose">{props.t("Certificate Request Purpose")}</Link>
                </li>
                <li>
                  <Link to="/applicant_received_through">{props.t("Applicant Received Through")}</Link>
                </li>
                <li>
                  <Link to="/courses">{props.t("Courses")}</Link>
                </li>
                {/* <li>
                  ...
                  {/* <li>
                  <Link to="/department_entry">{props.t("Department Entry")}</Link>
                </li> */}
                {/* <li>
                  <Link to="/detailed_subjects">{props.t("Detailed Subjects")}</Link>
                </li> */}
