      ...
      <header id="page-topbar">
        <div className="navbar-header">
          <div className="d-flex">
            ...
            <ul className="commonMenu list-unstyled d-none d-lg-block">
              <li className="d-none d-lg-inline-block ms-1">
                  <Link to="/dashboard">{props.t("Home")}</Link>
              </li>
              <li className="d-none d-lg-inline-block ms-1">
                  <Link to="#" onClick={opentab} >{props.t("About Us")}</Link>
              </li>
              <li className="d-none d-lg-inline-block ms-1">
                  <Link to="#">{props.t("Contact Us")}</Link>
              </li>
            </ul>
