...
const sub_religion = () => {
  //meta title
  document.title = "Knowledge pro | Sub Religion"
  ...
  const getsubReligion = () => {
    console.log(localStorage.getItem("token"))
    axios.get("http://localhost:8080/admin/adminPage/getAllReligionSection", {
      headers: {
  ...
  const createsubReligion = () => {
    ...
    axios.post("http://localhost:8080/admin/adminPage/addReligionSection", formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
      },
  ...
  const deletesubReligion = () => {
    ...
    axios.delete(`http://localhost:8080/admin/adminPage/deleteReligionSection/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    ...
    axios.get(`http://localhost:8080/admin/adminPage/getReligionSectionById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
    ...
    document.getElementById("religionId").value=user.religionId
  };
  ...
  const updatesubReligion = () => {
    let req = {
      ...
      religionId: formdetails.religionId
    }
    console.log("update-sub",req)

    axios.put("http://localhost:8080/admin/adminPage/updateReligionSection", req, {
...
const getReligion=()=>{
    console.log(localStorage.getItem("token"))
  axios.get("http://localhost:8080/admin/adminPage/getAllReligion", {
   headers: {
     'Authorization': `Bearer ${localStorage.getItem("token")}`,
     'Content-Type': 'application/json',
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Sub Religion" />
                  ...
                  <div className="table-rep-plugin">
                    ...
                    >
                      <Table
                        ...
                        <thead>
                          <tr>
                            <td align="right"><span className="mandatory">*</span>Religion:</td>
                            {/* <td align="left"><input type="text" name="name" value={formdetails.name} onChange={(e) => { handleInputChange(e) }}></input></td> */}
                            <td align="left" >
                        <select name="religionName" id="religionId" onChange={(e)=>{handleInputChange(e)}}>
                        ...
                        { 
                          return <option key={user.id} value={user.id}>{user.name}</option>
                            ...
                            <td align="right"><span className="mandatory">*</span> Caste:</td>
