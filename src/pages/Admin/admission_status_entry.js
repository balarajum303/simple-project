    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Admission Status Entry" />
                  ...
                  <div className="table-rep-plugin">
                    ...
                    >
                      ...
                      <div className="hstack gap-3 align-center">
                        <button type="button" className="btn btn-primary" onClick={isEdit ? updateAdmissionEntry : createAdmissionEntry}>{isEdit ? "Update" : "Submit"}</button>
                      ...
                      >
                        ...
                        <Tbody>
                          {admissionDetails.map((user, index) => <Tr key={index}>
                            <Td >{index + 1}</Td>
                            <Td>{user.name}</Td>
        ...
        <Modal show={show} centered={true} onHide={handleClose} animation={false}>
          ...
          <Modal.Footer>
            ...
            <Button variant="danger" onClick={(e) => { deleteAdmissionEntry() }}>
              Delete
            </Button>
          </Modal.Footer>
        </Modal>
