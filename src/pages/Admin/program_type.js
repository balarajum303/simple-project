...
const program_type = () => {
  ...
  const getdetails = () => {
    ...
    axios.get("http://localhost:8080/admin/adminPage/getAllProgramType", {
      headers: {
  ...
  /////------post---------------------------//////////////////////////////////
  const createdetails = () => {
    axios.post("http://localhost:8080/admin/adminPage/addProgramType",formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const deletedetails = () => {
    ...
    axios.delete(`http://localhost:8080/admin/adminPage/deleteProgramType/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    console.log(localStorage.getItem("token"))
    axios.get(`http://localhost:8080/admin/adminPage/getProgramTypeById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const updatedetails = () => {
    ...
    axios.put("http://localhost:8080/admin/adminPage/updateProgramType",req, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Program Type Entry" />
