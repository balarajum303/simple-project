...
const mother_tongue = () => {
  //meta title
  document.title = "Knowledge pro | Mother Tongue"
  ...
  const getMotherTongue = () => {
    ...
    axios.get("http://localhost:8080/admin/adminPage/getAllMotherTongue", {
      headers: {
  ...
  /////------post---------------------------//////////////////////////////////
  const createMotherTongue = () => {
    axios.post("http://localhost:8080/admin/adminPage/addMotherTongue", formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const deleteMotherTongue = () => {

    axios.delete(`http://localhost:8080/admin/adminPage/deleteMotherTongue/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    console.log(localStorage.getItem("token"))
    axios.get(`http://localhost:8080/admin/adminPage/getMotherTongueById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const updateMotherTongue = () => {
    ...
    axios.put("http://localhost:8080/admin/adminPage/updateMotherTongue", req, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="MotherTongue" />
                  ...
                  <div className="table-rep-plugin">
                    ...
                    >
                      <Table
                        ...
                        <thead>
                          <tr>
                            <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="mandatory">*</span>Mother Tongue:</td>
                      ...
                      <div className="hstack gap-3 align-center">
                        <button type="button" className="btn btn-primary" onClick={isEdit ? updateMotherTongue : createMotherTongue}>{isEdit ? "Update" : "Submit"}</button>
                      ...
                      >
                        <Thead>
                          <Tr>
                            ...
                            <Th data-priority="3">Mother Tongue</Th>
        ...
        <Modal show={show} centered={true} onHide={handleClose} animation={false}>
          ...
          <Modal.Footer>
            ...
            <Button variant="danger" onClick={(e) => { deleteMotherTongue() }}>
              Delete
            </Button>
          </Modal.Footer>
        </Modal>
...
// mother_tongue.propTypes = {
//   value: PropTypes.any,
//   onChange: PropTypes.func,
// }

export default mother_tongue
