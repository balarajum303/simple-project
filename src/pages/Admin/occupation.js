...
const occupation = () => {
  ...
  const getdetails = () => {
    ...
    axios.get("http://localhost:8080/admin/adminPage/getAllOccupation", {
      headers: {
  ...
  /////------post---------------------------//////////////////////////////////
  const createdetails = () => {
    axios.post("http://localhost:8080/admin/adminPage/addOccupation",formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const deletedetails = () => {
    ...
    axios.delete(`http://localhost:8080/admin/adminPage/deleteOccupation/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    console.log(localStorage.getItem("token"))
    axios.get(`http://localhost:8080/admin/adminPage/getOccupationById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const updatedetails = () => {
    ...
    axios.put("http://localhost:8080/admin/adminPage/updateOccupation",req, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Occupation Entry" />
                  ...
                  <div className="table-rep-plugin">
                    ...
                    >
                      <Table
                        ...
                        <thead>
                          <tr>
                            <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="mandatory">*</span>Occupation:</td>
