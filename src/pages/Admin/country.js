...
const admission_status_entry = () => {
  //meta title
  document.title = "Knowledge pro | Country"
  ...
  /////------post---------------------------//////////////////////////////////
  const createCountry = () => {
    axios.post("http://localhost:8080/admin/adminPage/addCountry", formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const deleteCountry = () => {
    ...
    axios.delete(`http://localhost:8080/admin/adminPage/deleteCountry/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    console.log(localStorage.getItem("token"))
    axios.get(`http://localhost:8080/admin/adminPage/getCountryById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const updateCountry = () => {
    ...
    axios.put("http://localhost:8080/admin/adminPage/updateCountry", req, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Country" />
...
// admission_status_entry.propTypes = {
//   value: PropTypes.any,
//   onChange: PropTypes.func,
// }

export default admission_status_entry
