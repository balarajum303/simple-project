...
const resident_category = () => {
  //meta title
  document.title = "Knowledge pro | Skote - React Admin & Dashboard Template"
  ...
  const getResidentCategory = () => {
    console.log(localStorage.getItem("token"))
    axios.get("http://localhost:8080/admin/adminPage/getAllResidentCategory", {
      headers: {
  ...
  /////------post---------------------------//////////////////////////////////
  const createResidentCategory = () => {
    axios.post("http://localhost:8080/admin/adminPage/addResidentCategory", formdetails, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const deleteResidentCategory = () => {
 
    axios.delete(`http://localhost:8080/admin/adminPage/deleteResidentCategory/${deleteId}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  const getEditEntry = (user) => {
    console.log(localStorage.getItem("token"))
    axios.get(`http://localhost:8080/admin/adminPage/getResidentCategoryById/${user.id}`, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem("token")}`,
        'Content-Type': 'application/json',
  ...
  ////////----- update----////////////
  const updateResidentCategory = () => {
    let req = {
      id: formdetails.id,
      name: formdetails.name
    }

    axios.put("http://localhost:8080/admin/adminPage/updateResidentCategory", req, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Admin" breadcrumbItem="Resident Category" />
                  ...
                  <div className="table-rep-plugin">
                    ...
                    >
                      <Table
                        ...
                        <thead>
                          <tr>
                            <td align="right"><span className="mandatory">*</span>Resident Category:</td>
                      ...
                      <div className="hstack gap-3 align-center">
                        <button type="button" className="btn btn-primary" onClick={isEdit ? updateResidentCategory : createResidentCategory}>{isEdit ? "Update" : "Submit"}</button>
                      ...
                      >
                        <Thead>
                          <Tr>
                            ...
                            <Th data-priority="3">Resident Category</Th>
        ...
        <Modal.Footer>
          ...
          <Button variant="danger"  onClick={(e)=>{deleteResidentCategory()}}>
            delete Changes
          </Button>
        </Modal.Footer>
      </Modal>
...
// resident_category.propTypes = {
//   value: PropTypes.any,
//   onChange: PropTypes.func,
// }

export default resident_category
